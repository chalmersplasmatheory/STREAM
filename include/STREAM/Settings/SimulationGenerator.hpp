...
namespace STREAM {
    ...
    public:
        ...
        void SimulationGenerator::DefineOptions_n_re(Settings*);
        void SimulationGenerator::ConstructEquation_n_re(EquationSystem*, Settings*, struct OtherQuantityHandler::eqn_terms*);
    };
}
