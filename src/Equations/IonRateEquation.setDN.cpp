 ...
 */
    ...
    for (len_t ir = 0; ir < Nr; ir++) {
        if(setIonization){
            ...
            if (Z0 == 1){
                NI(-1, ); //TODO: d/dn_cold(Ion[Z0-1][ir] * n_cold[ir] * V_n/V_p)
            } else if (Z0 > 1){
            ...
            if (Z0 == 0){
                NI(0, ); //TODO: d/dn_cold(-Ion[Z0][ir] * n_cold[ir] * V_n/V_n_tot)
            }else{
        ...
        if (Z0 == 0){
            NI(+1,); //TODO:  d/dn_cold(Rec[Z0+1][ir] * n_cold[ir] * V_p/V_n_tot)
        } else if (Z0 < Z){
